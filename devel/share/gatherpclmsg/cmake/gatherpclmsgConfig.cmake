...
if(gatherpclmsg_CONFIG_INCLUDED)
  return()
endif()
set(gatherpclmsg_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(gatherpclmsg_SOURCE_PREFIX /home/nvidia/isuLidar/src/gatherpclmsg)
  set(gatherpclmsg_DEVEL_PREFIX /home/nvidia/isuLidar/devel)
  set(gatherpclmsg_INSTALL_PREFIX "")
  set(gatherpclmsg_PREFIX ${gatherpclmsg_DEVEL_PREFIX})
else()
  set(gatherpclmsg_SOURCE_PREFIX "")
  set(gatherpclmsg_DEVEL_PREFIX "")
  set(gatherpclmsg_INSTALL_PREFIX /home/nvidia/isuLidar/install)
  set(gatherpclmsg_PREFIX ${gatherpclmsg_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'gatherpclmsg' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/isuLidar/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(gatherpclmsg_LIBRARY_DIRS ${lib_path})
      list(APPEND gatherpclmsg_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'gatherpclmsg'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND gatherpclmsg_LIBRARIES ${lib})
    endif()
  endif()
...
set(gatherpclmsg_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${gatherpclmsg_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 gatherpclmsg_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${gatherpclmsg_dep}_FOUND)
      find_package(${gatherpclmsg_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${gatherpclmsg_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(gatherpclmsg_INCLUDE_DIRS ${${gatherpclmsg_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(gatherpclmsg_LIBRARIES ${gatherpclmsg_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${gatherpclmsg_dep}_LIBRARIES})
  _list_append_deduplicate(gatherpclmsg_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(gatherpclmsg_LIBRARIES ${gatherpclmsg_LIBRARIES})

  _list_append_unique(gatherpclmsg_LIBRARY_DIRS ${${gatherpclmsg_dep}_LIBRARY_DIRS})
  list(APPEND gatherpclmsg_EXPORTED_TARGETS ${${gatherpclmsg_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${gatherpclmsg_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
