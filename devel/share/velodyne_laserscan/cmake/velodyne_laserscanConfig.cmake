...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_laserscan_SOURCE_PREFIX /home/nvidia/isuLidar/src/velodyne/velodyne_laserscan)
  set(velodyne_laserscan_DEVEL_PREFIX /home/nvidia/isuLidar/devel)
  ...
  set(velodyne_laserscan_INSTALL_PREFIX /home/nvidia/isuLidar/install)
...
if(NOT "/home/nvidia/isuLidar/devel/include " STREQUAL " ")
  set(velodyne_laserscan_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/isuLidar/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/isuLidar/src/velodyne/velodyne_laserscan/${idir}'.  Ask the maintainer 'Josh Whitley <jwhitley@autonomoustuff.com>' to fix it.")
    endif()
