...
if("TRUE" STREQUAL "TRUE")
  set(robot_localization_SOURCE_PREFIX /home/nvidia/isuLidar/src/robot_localization)
  set(robot_localization_DEVEL_PREFIX /home/nvidia/isuLidar/devel)
  ...
  set(robot_localization_INSTALL_PREFIX /home/nvidia/isuLidar/install)
...
if(NOT "/home/nvidia/isuLidar/devel/include;/home/nvidia/isuLidar/src/robot_localization/include;/usr/include/eigen3 " STREQUAL " ")
  set(robot_localization_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/isuLidar/devel/include;/home/nvidia/isuLidar/src/robot_localization/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'robot_localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/isuLidar/src/robot_localization/${idir}'.  Ask the maintainer 'Tom Moore <ayrton04@gmail.com>' to fix it.")
    endif()
