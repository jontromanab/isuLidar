...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_pointcloud_SOURCE_PREFIX /home/nvidia/isuLidar/src/velodyne/velodyne_pointcloud)
  set(velodyne_pointcloud_DEVEL_PREFIX /home/nvidia/isuLidar/devel)
  ...
  set(velodyne_pointcloud_INSTALL_PREFIX /home/nvidia/isuLidar/install)
...
if(NOT "/home/nvidia/isuLidar/devel/include;/home/nvidia/isuLidar/src/velodyne/velodyne_pointcloud/include " STREQUAL " ")
  set(velodyne_pointcloud_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/isuLidar/devel/include;/home/nvidia/isuLidar/src/velodyne/velodyne_pointcloud/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_pointcloud' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/isuLidar/src/velodyne/velodyne_pointcloud/${idir}'.  Ask the maintainer 'Josh Whitley <jwhitley@autonomoustuff.com>' to fix it.")
    endif()
