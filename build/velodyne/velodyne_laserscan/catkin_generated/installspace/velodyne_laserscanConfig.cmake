...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/isuLidar/install/${idir}'.  Ask the maintainer 'Josh Whitley <jwhitley@autonomoustuff.com>' to fix it.")
    endif()
